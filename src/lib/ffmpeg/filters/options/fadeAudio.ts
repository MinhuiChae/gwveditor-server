 ...
 */
 ...
 class FadeAudioFfilterOption {  
  private _start: number = 0;
  private _duration: number = 0;
  private _command: string[] = ['afade='];
  ...
  constructor(start: number, duration: number, type: EFadeFilterType){
    ...
    this._type = type;
    this._command.push(`t=${this.type}:st=${this.start}:d=${this.duration}`);
  }
 ...
 export default FadeAudioFfilterOption;